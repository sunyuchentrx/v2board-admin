...
await page.evaluateOnNewDocument(() => localStorage.setItem('v2board_admin_v2_auth', JSON.stringify({ authData: 'mock-jwt', isAdmin: true })))
await page.goto('http://localhost:5173/admin/v2' + route, { waitUntil: 'networkidle0' })
